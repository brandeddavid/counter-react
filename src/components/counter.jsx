    ...
    return (
        <div>
            ...
            <span id="decrementButton">
                <button onClick={this.handleDecrement} className="btn btn-info btn-sm m-2">-</button>
            </span>
            <span id="addButton">
                <button onClick={this.props.onAdd} className="btn btn-success btn-sm">Add</button>
            </span> 
